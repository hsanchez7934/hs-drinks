...
module.exports = [
  ...
  },
  {
    name: 'NECROMANCER',
    ingredients: [
      '3⁄4 oz Tenneyson Absinthe',
      '3⁄4 oz Lillet Blanc',
      '3⁄4 oz Pür Likör Blossom Elderflower Liqueur',
      '3⁄4 oz Lemon juice',
      '1 dash Gin',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1⁄4 oz Simple syrup',
      'splash: Lemon juice, G.E. Massenez Framboise Sauvage Raspberry Brandy, and Ginger beer',
  ...
  },
  {
    ...
    ingredients: [
      ...
      'Garnish: 1 Orange wheel and mint sprig',
      'Glass: Tall'
    ],
  ...
  {
    name: 'JACK DANIEL’S VIEUX CARRE',
    ingredients: [
      '3⁄4 oz Jack Daniel\'s Tennessee rye',
      '3⁄4 oz Cognac',
  ...
  },
  {
    name: 'MANDARIN JAMS',
    ingredients: [
      '1¼ ounces Mianzhu Daqu Laohao baijiu',
  ...
  },
  {
    name: '1870 SOUR',
    ingredients: [
      '2 oz George Dickel Old No. 8 Tennessee Whisky',
      '1 oz Meyer lemon juice',
      '3⁄4 oz Maple syrup',
      '1  Egg white',
      '1 tsp Blueberry jam',
      '1 oz Ravenswood Sonoma County Old Vine Zinfandel',
  ...
  {
    name: 'TENNESSEE TWO STEP',
    ingredients: [
      '1⁄2 oz Gran Gala',
      '1⁄2 oz Punt e Mes',
      '1 1⁄2 oz George Dickel Old No. 8 Tennessee Whisky',
      '2 dashes Angostura bitters',
      '3⁄4 oz Lemon juice',
      '1 pinch Sugar',
      '1 oz Seltzer',
      'Garnish: 1 Orange peel and grated nutmeg',
      'Glass: Cocktail'
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1⁄2 oz Black walnut–rosemary syrup*',
  ...
  },
  {
    name: 'HOLY SMOKES',
    ingredients: [
      '1 1⁄2 oz George Dickel Barrel Select Tennessee Whisky',
      '1⁄2 oz Cardamaro Vino Amaro',
      '1⁄2 oz Bénédictine',
      '2 dashes The Bitter Truth chocolate bitters',
      '1 tsp Ardbeg Uigeadail Single Malt Scotch Whisky',
  ...
  {
    name: 'WOODFORD RESERVE OLD FASHIONED',
    ingredients: [
  ...
  {
    name: 'WHISKEY SMASHED',
    ingredients: [
      '8 3⁄4 oz Woodford Reserve Kentucky straight bourbon',
      '9 oz Simple syrup',
      '7 1⁄4 oz Mint simple syrup*',
      '6 oz Fresh lemon juice',
      '6 3⁄4 oz Fresh lime juice',
      '2 3⁄4 oz Water',
  ...
  },
  {
    name: 'HORSE\'S NECK',
    ingredients: [
      '2 oz Bourbon, brandy or American rye whiskey, Ginger ale',
  ...
  },
  {
    ...
    ingredients: [
      '1 1⁄2 oz Stone Barn Brandyworks Pear Brandy',
      '1 oz Cointreau',
      '1⁄2 oz Fresh lemon juice',
  ...
  {
    name: 'TIMMY\'S BRANDY MILK PUNCH',
    ingredients: [
      '1 cup Brandy',
      '3 cup Milk',
  ...
  {
    name: 'IMPROVED BRANDY DAISY',
    ingredients: [
      '1 oz Hennessy V.S.O.P Privilège cognac',
      '1⁄2 oz Giffard Abricot du Roussillon liqueur',
      '1⁄2 oz Fresh lemon juice',
      '1⁄2 oz Simple syrup',
      '1 dash Angostura bitters',
      '1 oz Moët Impérial Champagne, to top',
      '1  Orange peel',
      'Glass: Coupe'
    ],
  ...
  },
  {
    ...
    ingredients: [
      '1⁄2 oz Rich simple syrup (two parts sugar, one part water)',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '3⁄4 oz Fresh lime juice',
      '1  Mint sprig',
      '1 3⁄4 oz Tanqueray London dry gin',
      '1 oz Ginger beer',
      'Garnish: 1 Mint sprig',
      'Glass: Highball'
    ],
  ...
  },
  {
    name: 'M GIN & TONIC',
    ingredients: [
      '1 oz Blaum Bros. Oak Reserve gin',
      ...
      'Garnish: 2 dehydrated lemon wheels, 1 cinnamon stick, 4 star anise',
      'Glass: Wine'
    ],
  ...
  {
    name: 'TAVERNONNA CLASSIC GIN RICKEY',
    ingredients: [
      '1 1⁄2 oz Builders gin',
      '1 dash Citric acid',
      '1 oz Lavender-infused soda water',
      '1 sprig Rosemary',
  ...
  },
  {
    name: '12TH MAN FIZZ',
    ingredients: [
      '1 1⁄2 oz OOLA gin (or other bright, floral gin)',
      '1⁄4 oz Apricot brandy',
      '1 oz Freshly Squeezed Lime Juice',
      '1⁄2 oz Simple syrup',
      '3 oz Rachel’s Ginger Beer (or other high-quality ginger beer)',
      '3  Mint leaves, shredded',
      '1⁄2 cup Blueberries',
      '1  Kiwi fruit, peeled and sliced in wheels',
      'Garnish: Mint leaf',
      'Glass: Collins'
    ],
  ...
  },
  {
    ...
    ingredients: [
      '2 oz The 86 Co. Cabeza blanco tequila',
      '3⁄4 oz Pineau des Charentes apéritif',
      '3⁄4 oz Martini bianco vermouth',
      '2 dashes Gran Classico bitter',
      'Garnish: Lime peel',
      'Glass: Georgian'
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      'Frangelico liqueur',
      'Garnish: Chocolate sauce, Whipped cream, Mint leaves',
      'Glass: Shot glass'
    ],
  ...
  },
  {
    name: 'RAISIN\' CANE',
    ingredients: [
      '2 oz Pierre Ferrand Pineau des Charentes apéritif',
      '1⁄2 oz Paranubes Oaxacan rum',
      '1⁄2 oz El Maestro Sierra amontillado sherry',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1 splash Pellegrino Mineral Water',
      'Garnish: 1 Flamed orange peel',
      'Glass: Highball'
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      '3⁄4 oz Cask-proof bourbon',
      '1 oz Fresh lemon juice',
      '1 tsp Rich simple syrup',
      '1⁄2 oz Egg white, beaten',
      'Garnish: 1 Lemon peel, 2 Skewered brandied cherries',
      'Glass: Old Fashioned'
    ],
  ...
  {
    name: 'MAYAHUEL’S ALL JACKED UP',
    ingredients: [
      '1 oz. mezcal',
      '1 oz. sweet vermouth',
      '¾ oz. 100-proof apple brandy (Laird’s recommended)',
      '¼ oz. Fernet-Branca',
  ...
  {
    name: 'PISCO IN THE TIME OF CHOLERA',
    ingredients: [
      '1 1/2 oz. Pisco Barsol Quebranta infused with baked eggplant chips',
      '1/2 oz. Lillet',
      '1 oz. lime juice',
      '1 oz. turbinado syrup',
      '1 oz. egg white',
      'dehydrated savory eggplant chip for garnish'
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1 oz. fresh lime juice',
      '1 oz. simple syrup infused with sakura tea',
      '1 oz. egg white',
      'Peychaud’s bitters and an edible flower for garnish'
  ...
  {
    name: 'RUMSKEY COCKTAIL',
    ingredients: [
      '1 1⁄2 oz White Rumskey',
      '1 oz Lemon juice',
  ...
  },
  {
    ...
    ingredients: [
      '2 oz Smith & Cross Traditional Jamaica Rum Lemonade',
      'Garnish: 1  Nutmeg or half a strawberry1, Orange slice',
      'Glass: Pint'
  ...
  },
  {
    ...
    ingredients: [
      ...
      '2 tsp Zucca Amaro',
      'lemon sherbet',
      '4 oz spicy ginger beer such as Blenheim’s Ginger Ale',
      '1 1⁄2 oz Aberlour 12yr Single Malt Scotch',
      'Glass: Highball'
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      '3⁄4 oz Dewar’s White Label',
      '3⁄4 oz D’USSÉ Cognac',
      '3⁄4 oz Lemon juice',
      '1⁄2 oz Simple syrup',
      '1⁄2 oz St-Germain',
      '1 dash Angostura bitters',
      'Garnish: Green apple fan',
      'Glass: Coupe'
    ],
  ...
  {
    name: 'THE ROBERT BARATHEON',
    ingredients: [
      '2 oz Aberlour 12 Year-Old Single Malt Scotch',
      '1⁄4 oz Dry vermouth',
  ...
  {
    name: 'GOLD LABEL FROST',
    ingredients: [
      '1 oz Johnnie Walker Gold Label Scotch Whisky',
      '5 oz Apple cider',
      'dash Apple bitters',
      'Garnish: 1 Lemon peel',
      'Glass: Collins'
  ...
  {
    name: 'HEBRIDEAN SHORES',
    ingredients: [
      '1 oz Bruichladdich The Classic Laddie scotch',
      '3⁄4 oz Freshly Squeezed Pink Grapefruit Juice',
      '1⁄2 oz Peach schnapps',
      '1⁄4 oz Fino sherry',
      'BrewDog Elvis Juice IPA float',
  ...
  },
  {
    name: 'IN MY DEFENSE',
    ingredients: [
      '1 1⁄2 oz Aberlour A’Bunadh scotch',
      '3⁄4 oz Cream sherry',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '3⁄4 oz Fresh lemon juice',
      '3⁄4 oz Grenadine',
      '1 oz Serrano-infused amontillado sherry',
  ...
  },
  {
    name: 'THE HENRY',
    ingredients: [
      '1 1/2 ounces aged rhum agricole, such as Clement',
      '1/2 ounce bourbon, such as Bulleit',
      '1 ounce sweet vermouth, such as Cocchi Vermouth di Torino',
      '3 dashes Angostura bitters',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '1 oz Boiron Pineapple Puree',
      '3⁄4 oz Fresh lemon juice',
      '1 oz Oloroso sherry',
      '1⁄2 oz Rosemary syrup',
      '1⁄4 oz Salted caramel syrup',
      '3 dashes Bittermens Tiki Bitters',
      'Garnish: Dried pineapple Torched (or fresh) rosemary',
  ...
  {
    name: 'LAVENDER HONEY CREAM',
    ingredients: [
      '1 1⁄2 oz Square One Botanical Spirit',
      '1 oz Organic heavy cream',
      '1 oz Organic egg white',
      '1 oz Lavender Honey Syrup',
      'Garnish: 1 Lavender blossoms',
      'Glass: Cocktail'
    ],
  ...
  },
  {
    ...
    ingredients: [
      '2 oz Smokin\' liqueur',
      '4 oz V8 vegetable juice cocktail',
  ...
  },
  {
    name: 'JUBILEE',
    ingredients: [
      '1 1⁄2 oz Elit by Stolichnaya',
      '1 1⁄2 oz Dry red wine',
      '1⁄2 oz St. George Spiced Pear Liqueur',
      '1⁄4 oz Maple syrup',
      '1⁄4 oz Lemon juice',
      '1 oz Seltzer',
      'Garnish: Pear fan and grated nutmeg',
      'Glass: Rocks'
    ],
  ...
  },
  {
    ...
    ingredients: [
      '1 1⁄2 oz Hangar One Spiced Pear Vodka (may substitute another pear vodka)',
      '1 1⁄2 oz St-Germain',
      '3⁄4 oz Fresh lime juice',
      '1 dash Angostura bitters',
  ...
  {
    name: 'FINLANDIA VODKA WILD BERRITINI',
    ingredients: [
      '3⁄4 oz Finlandia Wild Berries Fusion Vodka',
      '1⁄4 oz Finlandia Vodka',
      '1⁄4 oz Chambord',
      '1⁄4 oz Club soda',
      'Garnish: 1 Fresh berries',
      'Glass: Cocktail'
    ],
